...
```python
!jupyter nbconvert --to markdown "/content/drive/Mydrive/제어공학1/2주차 강의 요약_2019372075_이귀용.ipynb"
```

    [NbConvertApp] WARNING | pattern '/content/drive/Mydrive/제어공학1/2주차 강의 요약_2019372075_이귀용.ipynb' matched no files
